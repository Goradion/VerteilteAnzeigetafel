...
public class ClientWindow extends javax.swing.JFrame implements Runnable{
    ...
    private void initComponents() {
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {newMessageRB, userIDTextField});

        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {abteilungLabel, abteilungTextField});
...
//        abteilungTextField.selectAll();
    ...
    private void sendQueryButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_sendQueryButtonMouseClicked
        if(newMessageRB.isSelected() && !abteilungTextField.getText().isEmpty() 
                && !userIDTextField.getText().isEmpty() && !messageTextArea.getText().isEmpty()){
            client.sendeMessageWithGui(Integer.parseInt(abteilungTextField.getText()),
        ...
        if(deleteMessageRB.isSelected() && !abteilungTextField.getText().isEmpty() 
            ...
            client.removeMessageWithGui(Integer.parseInt(abteilungTextField.getText()),
                    Integer.parseInt(userIDTextField.getText()),
                    Integer.parseInt(messageIDTextField.getText()));
        }
